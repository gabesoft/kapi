               ...
               let end = ptr `plusPtr` (off + len)
                   loop curPtr = do
                     ...
                     case res of
                       ...
                       _ -> throw (DecodeError desc Nothing)
...
unescapeText :: Text -> Either UnicodeException Text
unescapeText = unsafeDupablePerformIO . try . evaluate . unescapeText' . encodeUtf8
